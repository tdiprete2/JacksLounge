import { type User, type InsertUser, type ReviewStats, type InsertReviewStats, type Review, type InsertReview, type ContactRequest, type InsertContactRequest } from "@shared/schema";
