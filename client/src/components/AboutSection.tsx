          ...
          <div className="order-1 lg:order-2">
            ...
            <div className="space-y-4 text-lg text-foreground/90 leading-relaxed">
              <p data-testid="text-about-para-1">
                At Jack's Lounge, we blend easygoing vibes with hearty Italian favorites, pizza and wings, creating a welcoming spot where locals gather to enjoy great food, friendly service, and unbeatable value. Our passion is serving up delicious, comforting meals that feel like home—whether you're dining in or taking our food to go.
              </p>
